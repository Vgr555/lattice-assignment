...
public class PatientController {
    ...
    public ResponseEntity<Patient> getPatientById(@PathParam("patientId") Integer patientId){
    ...
    public ResponseEntity<String> deletePatient(@PathParam("patientId") Integer patientId){
